...
namespace xtext {
    ...
    //   if (!xtext::c_decode(s, &unescaped_s)) { ... }
    ...
    //   std::string escaped_s = xtext::c_encode(s);
    ...
    //
    //   std::string s = "foo\rbar\tbaz\010\011\012\013\014\x0d\n";
    //   std::string escaped_s = xtext::c_hex_encode(s);
    ...
    // true on success.
    XTEXT_MUST_USE_RESULT bool hex_string_to_bytes(std::string_view hex,
                                                std::string *bytes);
