#ifndef XTEXT_SIMDUTF_ARM64_IMPLEMENTATION_H
#define XTEXT_SIMDUTF_ARM64_IMPLEMENTATION_H
...
public:
  xtext_really_inline implementation()
      : xtext::implementation("arm64", "ARM NEON",
...
#endif // XTEXT_SIMDUTF_ARM64_IMPLEMENTATION_H
