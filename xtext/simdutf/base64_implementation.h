#ifndef XTEXT_SIMDUTF_BASE64_IMPLEMENTATION_H
#define XTEXT_SIMDUTF_BASE64_IMPLEMENTATION_H
...
xtext_warn_unused xtext_constexpr23 result slow_base64_to_binary_safe_impl(
...
template <typename chartype>
xtext_warn_unused xtext_constexpr23 result base64_to_binary_safe_impl(
    const chartype *input, size_t length, char *output, size_t &outlen,
    base64_options options,
  ...
  xtext_log_assert(r.input_count <= safe_input,
                     "You should not read more than safe_input");
  xtext_log_assert(r.output_count <= remaining_output_length,
...
#endif // XTEXT_SIMDUTF_BASE64_IMPLEMENTATION_H
