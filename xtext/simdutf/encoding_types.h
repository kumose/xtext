#ifndef XTEXT_SIMDUTF_ENCODING_TYPES_H
#define XTEXT_SIMDUTF_ENCODING_TYPES_H
#include <string_view>
#include <xtext/simdutf/portability.h>
#include <xtext/simdutf/common_defs.h>

#if !defined(XTEXT_SIMDUTF_NO_STD_TEXT_ENCODING) &&                                  \
    defined(__cpp_lib_text_encoding) && __cpp_lib_text_encoding >= 202306L
  #define XTEXT_SIMDUTF_HAS_STD_TEXT_ENCODING 1
...
enum encoding_type {
  ...
  #error "XTEXT_SIMDUTF_IS_BIG_ENDIAN needs to be defined."
#endif
...
xtext_warn_unused xtext_really_inline constexpr bool
match_system(endianness e) {
  return e == endianness::NATIVE;
}

xtext_warn_unused std::string_view to_string(encoding_type bom);
...
xtext_warn_unused encoding_type check_bom(const uint8_t *byte, size_t length);
xtext_warn_unused encoding_type check_bom(const char *byte, size_t length);
/**
 ...
 */
xtext_warn_unused size_t bom_byte_size(encoding_type bom);
 ...
 */
xtext_warn_unused constexpr std::text_encoding
 ...
 */
xtext_warn_unused constexpr encoding_type
 ...
 */
xtext_warn_unused constexpr encoding_type native_utf16_encoding() noexcept {
  #if XTEXT_SIMDUTF_IS_BIG_ENDIAN
  return UTF16_BE;
  #else
  return UTF16_LE;
 ...
 */
xtext_warn_unused constexpr encoding_type native_utf32_encoding() noexcept {
  #if XTEXT_SIMDUTF_IS_BIG_ENDIAN
  return UTF32_BE;
  #else
  return UTF32_LE;
