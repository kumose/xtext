#ifndef XTEXT_SIMDUTF_IMPLEMENTATION_H
#define XTEXT_SIMDUTF_IMPLEMENTATION_H
#if !defined(XTEXT_SIMDUTF_NO_THREADS)
  #include <atomic>
#endif
...
//      #endif
//
#ifndef XTEXT_SIMDUTF_FEATURE_DETECT_ENCODING
  #define XTEXT_SIMDUTF_FEATURE_DETECT_ENCODING 1
#endif
#ifndef XTEXT_SIMDUTF_FEATURE_ASCII
  #define XTEXT_SIMDUTF_FEATURE_ASCII 1
#endif
#ifndef XTEXT_SIMDUTF_FEATURE_LATIN1
  #define XTEXT_SIMDUTF_FEATURE_LATIN1 1
#endif
#ifndef XTEXT_SIMDUTF_FEATURE_UTF8
  #define XTEXT_SIMDUTF_FEATURE_UTF8 1
#endif
#ifndef XTEXT_SIMDUTF_FEATURE_UTF16
  #define XTEXT_SIMDUTF_FEATURE_UTF16 1
#endif
#ifndef XTEXT_SIMDUTF_FEATURE_UTF32
  #define XTEXT_SIMDUTF_FEATURE_UTF32 1
#endif
#ifndef XTEXT_SIMDUTF_FEATURE_BASE64
  #define XTEXT_SIMDUTF_FEATURE_BASE64 1
#endif

#if XTEXT_SIMDUTF_CPLUSPLUS23
  #include <xtext/simdutf/constexpr_ptr.h>
#endif
...
concept indexes_into_byte_like = requires(InputPtr p) {
  { std::decay_t<decltype(p[0])>{} } -> xtext::detail::byte_like;
};
template <class InputPtr>
 ...
 * E.g., the function might return xtext::encoding_type::UTF8,
 * xtext::encoding_type::UTF16_LE, xtext::encoding_type::UTF16_BE, or
 * xtext::encoding_type::UTF32_LE.
 *
...
xtext_really_inline xtext_warn_unused xtext::encoding_type
 ...
 * the value (xtext::encoding_type::UTF8 | xtext::encoding_type::UTF16_LE).
 *
 ...
 * @return the detected encoding type
 */
xtext_warn_unused int detect_encodings(const char *input,
                                         size_t length) noexcept;
xtext_really_inline xtext_warn_unused int
...
xtext_warn_unused bool validate_utf8(const char *buf, size_t len) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_constexpr23 xtext_really_inline xtext_warn_unused bool
 ...
 * @param buf the UTF-8 string to validate.
 * @param len the length of the string in bytes.
 * @return a result pair struct (of type xtext::result containing the two
...
xtext_warn_unused result validate_utf8_with_errors(const char *buf,
                                                     size_t len) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_constexpr23 xtext_warn_unused result
validate_utf8_with_errors(
    const detail::input_span_of_byte_like auto &input) noexcept {
    #if XTEXT_SIMDUTF_CPLUSPLUS23
  if consteval {
...
xtext_warn_unused bool validate_ascii(const char *buf, size_t len) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 bool
...
xtext_warn_unused result validate_ascii_with_errors(const char *buf,
                                                      size_t len) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 result
 ...
 * @return true if and only if the string is valid ASCII.
 */
xtext_warn_unused bool validate_utf16_as_ascii(const char16_t *buf,
                                                 size_t len) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 bool
...
xtext_warn_unused bool validate_utf16le(const char16_t *buf,
                                          size_t len) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_constexpr23 xtext_warn_unused bool
...
void to_well_formed_utf16le(const char16_t *input, size_t len,
  ...
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_constexpr23 void
 ...
 */
xtext_warn_unused size_t convert_latin1_to_utf8(const char *input,
                                                  size_t length,
                                                  char *utf8_output) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 size_t
 ...
 */
xtext_warn_unused size_t convert_utf8_to_latin1(const char *input,
                                                  size_t length,
 ...
 */
xtext_warn_unused size_t utf8_length_from_latin1(const char *input,
                                                   size_t length) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 size_t
 ...
 */
xtext_warn_unused size_t latin1_length_from_utf8(const char *input,
                                                   size_t length) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 size_t
 ...
 * string
 */
xtext_warn_unused size_t convert_utf16_to_utf8(const char16_t *input,
                                                 size_t length,
 ...
 * @return the number of written char; 0 if conversion is not possible
 */
xtext_warn_unused size_t convert_utf16_to_utf8_safe(const char16_t *input,
                                                      size_t length,
                                                      char *utf8_output,
                                                      size_t utf8_len) noexcept;
  #if XTEXT_SIMDUTF_SPAN
 ...
 * string
 */
xtext_warn_unused size_t convert_utf16le_to_utf8(const char16_t *input,
                                                   size_t length,
                                                   char *utf8_buffer) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 size_t
 ...
 * string
 */
xtext_warn_unused size_t convert_utf16be_to_utf8(const char16_t *input,
                                                   size_t length,
                                                   char *utf8_buffer) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 size_t
...
xtext_warn_unused size_t convert_valid_utf16le_to_latin1(
    const char16_t *input, size_t length, char *latin1_buffer) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_constexpr23 xtext_warn_unused size_t
 ...
 */
xtext_warn_unused size_t convert_utf32_to_utf8(const char32_t *input,
                                                 size_t length,
                                                 char *utf8_buffer) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 size_t
 ...
 */
xtext_warn_unused xtext_really_inline xtext_constexpr23 size_t
...
xtext_warn_unused size_t count_utf8(const char *input,
                                      size_t length) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 size_t count_utf8(
    const detail::input_span_of_byte_like auto &valid_utf8_input) noexcept {
    #if XTEXT_SIMDUTF_CPLUSPLUS23
  if consteval {
    return scalar::utf8::count_code_points(valid_utf8_input.data(),
...
#if XTEXT_SIMDUTF_FEATURE_BASE64 || XTEXT_SIMDUTF_FEATURE_UTF16 ||                         \
    XTEXT_SIMDUTF_FEATURE_DETECT_ENCODING
  #ifndef XTEXT_SIMDUTF_NEED_TRAILING_ZEROES
    #define XTEXT_SIMDUTF_NEED_TRAILING_ZEROES 1
  #endif
#endif // XTEXT_SIMDUTF_FEATURE_BASE64 || XTEXT_SIMDUTF_FEATURE_UTF16 ||
       // XTEXT_SIMDUTF_FEATURE_DETECT_ENCODING
...
inline xtext_constexpr23 bool
is_partial(last_chunk_handling_options options) {
  return (options == stop_before_partial) || (options == only_full_chunks);
}

namespace detail {
xtext_warn_unused const char *find(const char *start, const char *end,
                                     char character) noexcept;
xtext_warn_unused const char16_t *
 ...
 *
 */
xtext_warn_unused xtext_really_inline xtext_constexpr23 const char *
...
xtext_warn_unused xtext_really_inline xtext_constexpr23 const char16_t *
find(const char16_t *start, const char16_t *end, char16_t character) noexcept {
  ...
  #include <xtext/simdutf/base64_tables.h>
 ...
 *
 * The default option (xtext::base64_default) expects the characters `+` and
 * `/` as part of its alphabet. The URL option (xtext::base64_url) expects the
 ...
 */
inline xtext_warn_unused xtext_constexpr23 size_t base64_length_from_binary(
 ...
 * @return number of base64 bytes
 */
inline xtext_warn_unused xtext_constexpr23 size_t
 ...
 *
 * The default option (xtext::base64_default) uses the characters `+` and `/`
 ...
 *
 * The URL option (xtext::base64_url) uses the characters `-` and `_` as part
...
binary_to_base64_with_lines(const char *input, size_t length, char *output,
                            size_t line_length = xtext::default_line_length,
                            base64_options options = base64_default) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 size_t
 ...
 * (see the CMake option XTEXT_SIMDUTF_ATOMIC_BASE64_TESTS) nor is it fuzz tested.
...
atomic_binary_to_base64(const char *input, size_t length, char *output,
                        base64_options options = base64_default) noexcept;
    #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused size_t
 ...
 * but can also be last_chunk_handling_options::strict or
 * last_chunk_handling_options::stop_before_partial.
 * @return a full_result struct (of type xtext::full_result containing the
 * three fields error, input_count and output_count).
 */
xtext_warn_unused full_result
base64_to_binary_details(const char *input, size_t length, char *output,
                         base64_options options = base64_default,
                         last_chunk_handling_options last_chunk_options =
                             last_chunk_handling_options::loose) noexcept;
  #if XTEXT_SIMDUTF_SPAN
xtext_really_inline xtext_warn_unused xtext_constexpr23 full_result
 ...
 * otherwise.
 */
xtext_warn_unused xtext_really_inline xtext_constexpr23 bool
 ...
 */
xtext_really_inline xtext_warn_unused std::tuple<result, std::size_t>
 ...
 * @return a tuple of result and outlen
 */
xtext_warn_unused std::tuple<result, std::size_t>
atomic_base64_to_binary_safe(
...
public:
   ...
   *
   *     const implementation *impl = xtext::active_implementation;
   ...
   * @return true if and only if the string is valid UTF-8.
   */
  xtext_warn_unused virtual bool validate_utf8(const char *buf,
   ...
   * if successful.
   */
  xtext_warn_unused virtual result
   ...
   * @return true if and only if the string is valid ASCII.
   */
  xtext_warn_unused virtual bool
   ...
   * @return the number of written char; 0 if conversion is not possible
   */
  xtext_warn_unused virtual size_t
   ...
   * if successful.
   */
  xtext_warn_unused virtual result convert_utf8_to_utf16le_with_errors(
   ...
   * if successful.
   */
  xtext_warn_unused virtual result convert_utf8_to_utf16be_with_errors(
      const char *input, size_t length,
      char16_t *utf16_output) const noexcept = 0;
  /**
   ...
   * necessarily valid.
   */
  virtual xtext_warn_unused result utf8_length_from_utf16le_with_replacement(
   ...
   * necessarily valid.
   */
  virtual xtext_warn_unused result utf8_length_from_utf16be_with_replacement(
      const char16_t *input, size_t length) const noexcept = 0;
   ...
   * @return number of written code units
   */
  xtext_warn_unused virtual size_t convert_utf16le_to_utf8_with_replacement(
   ...
   * @return number of written code units
   */
  xtext_warn_unused virtual size_t convert_utf16be_to_utf8_with_replacement(
      const char16_t *input, size_t length,
      char *utf8_buffer) const noexcept = 0;
   ...
   * successful.
   */
  xtext_warn_unused virtual result convert_utf16le_to_utf32_with_errors(
      const char16_t *input, size_t length,
      char32_t *utf32_buffer) const noexcept = 0;
   ...
   * successful.
   */
  xtext_warn_unused virtual result convert_utf16be_to_utf32_with_errors(
      const char16_t *input, size_t length,
      char32_t *utf32_buffer) const noexcept = 0;
   ...
   * successful.
   */
  xtext_warn_unused virtual result convert_utf32_to_utf16le_with_errors(
   ...
   * successful.
   */
  xtext_warn_unused virtual result convert_utf32_to_utf16be_with_errors(
      const char32_t *input, size_t length,
      char16_t *utf16_buffer) const noexcept = 0;
   ...
   * base64_url, is base64_default by default.
   * @param last_chunk_options the handling of the last chunk (default: loose)
   * @return a full_result pair struct (of type xtext::result containing the
   * three fields error, input_count and output_count).
   */
  xtext_warn_unused virtual full_result base64_to_binary_details(
      const char *input, size_t length, char *output,
      base64_options options = base64_default,
      last_chunk_handling_options last_chunk_options =
          last_chunk_handling_options::loose) const noexcept = 0;
   ...
   * @return number of base64 bytes
   */
  xtext_warn_unused size_t base64_length_from_binary(
   ...
   *
   * The URL option (xtext::base64_url) uses the characters `-` and `_` as
...
protected:
   ...
   * requires
   */
  xtext_really_inline implementation(const char *name,
...
public:
  ...
  xtext_really_inline available_implementation_list() {}
   ...
   * xtext::available_implementations["westmere"]; if (!impl) { exit(1); } if
   * (!imp->supported_by_runtime_system()) { exit(1); }
   *     xtext::active_implementation = impl;
   *
   ...
   *
   *     const implementation *impl =
   * xtext::available_implementation::detect_best_supported();
   *     xtext::active_implementation = impl;
   *
 ...
 * The list of available implementations compiled into simdutf.
 */
extern XTEXT_SIMDUTF_DLLIMPORTEXPORT const internal::available_implementation_list &
 ...
 */
extern XTEXT_SIMDUTF_DLLIMPORTEXPORT internal::atomic_ptr<const implementation> &
get_active_implementation();
  ...
  #include <xtext/simdutf/base64_implementation.h>
 ...
 */
xtext_really_inline
    xtext_constexpr23 xtext_warn_unused std::tuple<result, std::size_t>
 ...
 */
xtext_really_inline
    xtext_warn_unused xtext_constexpr23 std::tuple<result, std::size_t>
    base64_to_binary_safe(
        std::span<const char16_t> input,
        detail::output_span_of_byte_like auto &&binary_output,
        base64_options options = base64_default,
...
#if XTEXT_SIMDUTF_CPLUSPLUS23 && XTEXT_SIMDUTF_FEATURE_BASE64
 ...
 *
 * Usage:
 *   using namespace xtext::literals;
...
#endif // XTEXT_SIMDUTF_CPLUSPLUS23 && XTEXT_SIMDUTF_FEATURE_BASE64

#endif // XTEXT_SIMDUTF_IMPLEMENTATION_H
