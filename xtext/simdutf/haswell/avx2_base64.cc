...
xtext_really_inline __m256i lookup_pshufb_improved(const __m256i input) {
...
xtext_really_inline __m256i insert_line_feed32(__m256i input, int K) {
...
xtext_really_inline void compress(__m256i data, uint32_t mask, char *output) {
  if (mask == 0) {
...
template <typename = void>
xtext_really_inline void base64_decode(char *out, __m256i str) {
  // credit: aqrit
...
template <typename = void>
xtext_really_inline void base64_decode_block(char *out, const char *src) {
  base64_decode(out,
...
template <typename = void>
xtext_really_inline void base64_decode_block_safe(char *out,
                                                    const char *src) {
  base64_decode(out,
                _mm256_loadu_si256(reinterpret_cast<const __m256i *>(src)));
...
public:
  ...
  xtext_really_inline block64(const char *src) {
  ...
  // bytes available from reading at src.
  xtext_really_inline block64(const char16_t *src) {
  ...
  xtext_really_inline void copy_block(char *output) {
  ...
  xtext_really_inline void base64_decode_block(char *out) {
  ...
  xtext_really_inline uint64_t to_base64_mask(uint64_t *error) {
    uint32_t err0 = 0;
    uint32_t err1 = 0;
  ...
  template <bool base64_url, bool ignore_garbage, bool default_or_url>
  xtext_really_inline uint32_t to_base64_mask(__m256i *src, uint32_t *error) {
  ...
  xtext_really_inline uint64_t compress_block(uint64_t mask, char *output) {
  ...
  xtext_really_inline size_t compress_block_single(uint64_t mask,
                                                     char *output) {
...
xtext_warn_unused size_t avx2_binary_length_from_base64(const char *input,
                                                          size_t length) {
  size_t count = 0;
...
xtext_warn_unused size_t avx2_binary_length_from_base64(const char16_t *input,
                                                          size_t length) {
  size_t count = 0;
