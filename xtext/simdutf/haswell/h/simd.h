#ifndef XTEXT_SIMDUTF_HASWELL_SIMD_H
#define XTEXT_SIMDUTF_HASWELL_SIMD_H
...
struct base8 : base<simd8<T>> {
  ...
  friend xtext_always_inline Mask operator==(const simd8<T> lhs,
                                               const simd8<T> rhs) {
...
template <typename T> struct base8_numeric : base8<T> {
  ...
  static xtext_really_inline simd8<T> zero() {
...
template <typename T> struct simd8x64 {
  ...
  xtext_really_inline uint64_t in_range(const T low, const T high) const {
...
#include <xtext/simdutf/haswell/h/simd16-inl.h>
#include <xtext/simdutf/haswell/h/simd32-inl.h>
#include <xtext/simdutf/haswell/h/simd64-inl.h>
...
#endif // XTEXT_SIMDUTF_HASWELL_SIMD_H
