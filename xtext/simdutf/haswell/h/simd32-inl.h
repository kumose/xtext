...
template <> struct simd32<uint32_t> {
  ...
  xtext_really_inline simd32(const __m256i v) : value(v) {}
...
xtext_really_inline simd32<uint32_t> min(const simd32<uint32_t> b,
...
xtext_really_inline simd32<uint32_t> operator&(const simd32<uint32_t> b,
                                                 const simd32<uint32_t> a) {
