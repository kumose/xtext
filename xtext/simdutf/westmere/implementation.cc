...
must_be_2_3_continuation(const simd8<uint8_t> prev2,
  ...
  #include <xtext/simdutf/westmere/sse_convert_latin1_to_utf8.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1

#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_LATIN1
  #include <xtext/simdutf/westmere/sse_convert_latin1_to_utf16.cc>
  ...
  #include <xtext/simdutf/westmere/sse_convert_latin1_to_utf32.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF32 && XTEXT_SIMDUTF_FEATURE_LATIN1

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16
  #include <xtext/simdutf/westmere/sse_convert_utf8_to_utf16.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/westmere/sse_convert_utf8_to_utf32.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1
  #include <xtext/simdutf/westmere/sse_convert_utf8_to_latin1.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1

#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_LATIN1
  #include <xtext/simdutf/westmere/sse_convert_utf16_to_latin1.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_LATIN1

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16
  #include <xtext/simdutf/westmere/sse_convert_utf16_to_utf8.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16

#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/westmere/sse_convert_utf16_to_utf32.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_UTF32 && XTEXT_SIMDUTF_FEATURE_LATIN1
  #include <xtext/simdutf/westmere/sse_convert_utf32_to_latin1.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF32 && XTEXT_SIMDUTF_FEATURE_LATIN1

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/westmere/sse_convert_utf32_to_utf8.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/westmere/sse_convert_utf32_to_utf16.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_BASE64
  #include <xtext/simdutf/westmere/sse_base64.cc>
