...
// xtext::tables::utf16_to_utf8::pack_1_2_utf8_bytes index
...
#if XTEXT_SIMDUTF_FEATURE_UTF8 && (XTEXT_SIMDUTF_FEATURE_UTF16 || XTEXT_SIMDUTF_FEATURE_UTF32)
// common functions for utf8 conversions
xtext_really_inline __m128i convert_utf8_3_byte_to_utf16(__m128i in) {
...
xtext_really_inline __m128i convert_utf8_2_byte_to_utf16(__m128i in) {
...
convert_utf8_1_to_2_byte_to_utf16(__m128i in, size_t shufutf8_idx) {
  ...
  __m128i sh =
      __lsx_vld(reinterpret_cast<const uint8_t *>(
                    xtext::tables::utf8_to_utf16::shufutf8[shufutf8_idx]),
                0);
  // Shuffle
  ...
  return composed;
       ...
       // XTEXT_SIMDUTF_FEATURE_UTF32)

#if XTEXT_SIMDUTF_FEATURE_UTF16 || XTEXT_SIMDUTF_FEATURE_DETECT_ENCODING
  #include <xtext/simdutf/lsx/lsx_validate_utf16.cc>
  ...
  #include <xtext/simdutf/lsx/lsx_validate_utf32le.cc>
  ...
  #include <xtext/simdutf/lsx/lsx_convert_latin1_to_utf32.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF32 && XTEXT_SIMDUTF_FEATURE_LATIN1

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16
  #include <xtext/simdutf/lsx/lsx_convert_utf8_to_utf16.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16
#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/lsx/lsx_convert_utf8_to_utf32.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32
#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1
  #include <xtext/simdutf/lsx/lsx_convert_utf8_to_latin1.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1

#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_LATIN1
  #include <xtext/simdutf/lsx/lsx_convert_utf16_to_latin1.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_LATIN1
#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF8
  #include <xtext/simdutf/lsx/lsx_convert_utf16_to_utf8.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF8
#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/lsx/lsx_convert_utf16_to_utf32.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_UTF32 && XTEXT_SIMDUTF_FEATURE_LATIN1
  #include <xtext/simdutf/lsx/lsx_convert_utf32_to_latin1.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF32 && XTEXT_SIMDUTF_FEATURE_LATIN1
#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/lsx/lsx_convert_utf32_to_utf8.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32
#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/lsx/lsx_convert_utf32_to_utf16.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32
#if XTEXT_SIMDUTF_FEATURE_BASE64
  #include <xtext/simdutf/lsx/lsx_base64.cc>
  #include <xtext/simdutf/lsx/lsx_find.cc>
...
#include <xtext/simdutf/generic/buf_block_reader.h>
  ...
  #include <xtext/simdutf/generic/utf8/utf16_length_from_utf8_bytemask.h>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16
  ...
  #include <xtext/simdutf/generic/utf16/count_code_points_bytemask.h>
  #include <xtext/simdutf/generic/utf16/change_endianness.h>
  #include <xtext/simdutf/generic/utf16/utf8_length_from_utf16_bytemask.h>
  #include <xtext/simdutf/generic/utf16/utf32_length_from_utf16.h>
  #include <xtext/simdutf/generic/utf16/to_well_formed.h>
...
#if XTEXT_SIMDUTF_FEATURE_BASE64
  #include <xtext/simdutf/generic/base64lengths.h>
#endif // XTEXT_SIMDUTF_FEATURE_BASE64
