#ifndef XTEXT_SIMDUTF_LSX_IMPLEMENTATION_H
#define XTEXT_SIMDUTF_LSX_IMPLEMENTATION_H
...
public:
  xtext_really_inline implementation()
      : xtext::implementation("lsx", "LOONGARCH SX",
...
#endif // XTEXT_SIMDUTF_LSX_IMPLEMENTATION_H
