#ifndef XTEXT_SIMDUTF_LSX_SIMD_H
#define XTEXT_SIMDUTF_LSX_SIMD_H
...
template <typename T, typename Mask = simd8<bool>> struct base_u8 {
  ...
  xtext_really_inline base_u8(const __m128i _value) : value(_value) {}
  xtext_really_inline operator const __m128i &() const { return this->value; }
  xtext_really_inline operator __m128i &() { return this->value; }
...
template <> struct simd8<bool> : base_u8<bool> {
  ...
  xtext_really_inline simd8(const __m128i _value) : base_u8<bool>(_value) {}
  // False constructor
  xtext_really_inline simd8() : simd8(__lsx_vldi(0)) {}
  // Splat constructor
...
template <> struct simd8<uint8_t> : base_u8<uint8_t> {
  ...
  static xtext_really_inline simd8<uint8_t> zero() { return __lsx_vldi(0); }
  ...
  xtext_really_inline simd8 &operator-=(const simd8<uint8_t> other) {
...
template <> struct simd8<int8_t> {
  ...
  static xtext_really_inline simd8<int8_t> zero() { return __lsx_vldi(0); }
  ...
  // Conversion from/to SIMD register
  xtext_really_inline simd8(const __m128i _value) : value(_value) {}
...
#include <xtext/simdutf/lsx/h/simd16-inl.h>
#include <xtext/simdutf/lsx/h/simd32-inl.h>
#include <xtext/simdutf/lsx/h/simd64-inl.h>
...
#endif // XTEXT_SIMDUTF_LSX_SIMD_H
