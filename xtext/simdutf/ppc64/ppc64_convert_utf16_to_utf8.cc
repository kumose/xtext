...
template <typename T>
xtext_really_inline void ppc64_convert_utf16_to_1_2_3_bytes_of_utf8(
  ...
  */
  ...
  const uint8_t *row0 =
      &xtext::tables::ppc64_utf16_to_utf8::pack_1_2_3_utf8_bytes[mask0][0];
  ...
  const uint8_t *row1 =
      &xtext::tables::ppc64_utf16_to_utf8::pack_1_2_3_utf8_bytes[mask1][0];
