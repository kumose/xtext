#ifndef XTEXT_SIMDUTF_PPC64_IMPLEMENTATION_H
#define XTEXT_SIMDUTF_PPC64_IMPLEMENTATION_H
...
template <size_t N> xtext_really_inline size_t align_down(size_t size) {
  return N * (size / N);
}
} // namespace

class implementation final : public xtext::implementation {
public:
  xtext_really_inline implementation()
      : xtext::implementation("ppc64", "PPC64 ALTIVEC",
  ...
  xtext_warn_unused bool validate_utf8(const char *buf,
  ...
  xtext_warn_unused bool validate_ascii(const char *buf,
                                          size_t len) const noexcept final;
  xtext_warn_unused result
...
#if XTEXT_SIMDUTF_FEATURE_UTF8
  xtext_warn_unused size_t count_utf8(const char *buf,
...
#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16
  xtext_warn_unused size_t utf16_length_from_utf8(
...
#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32
  xtext_warn_unused size_t utf32_length_from_utf8(
      const char *input, size_t length) const noexcept override;
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1
  xtext_warn_unused size_t latin1_length_from_utf8(
      const char *input, size_t length) const noexcept override;
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1
  xtext_warn_unused size_t utf8_length_from_latin1(
      const char *input, size_t length) const noexcept override;
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1
...
#endif // XTEXT_SIMDUTF_PPC64_IMPLEMENTATION_H
