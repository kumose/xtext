#ifndef XTEXT_SIMDUTF_PPC64_SIMD_H
#define XTEXT_SIMDUTF_PPC64_SIMD_H
...
#include <xtext/simdutf/ppc64/h/simd8-inl.h>
#include <xtext/simdutf/ppc64/h/simd16-inl.h>
#include <xtext/simdutf/ppc64/h/simd32-inl.h>
...
xtext_really_inline vector_u8 as_vector_u8(const vector_u16 v) {
  return vector_u8::vector_type(v.value);
}

xtext_really_inline vector_u8 as_vector_u8(const vector_u32 v) {
  return vector_u8::vector_type(v.value);
}

xtext_really_inline vector_u8 as_vector_u8(const vector_i8 v) {
  return vector_u8::vector_type(v.value);
}

xtext_really_inline vector_u8 as_vector_u8(const simd16<bool> v) {
  return vector_u8::vector_type(v.value);
}

xtext_really_inline vector_i8 as_vector_i8(const vector_u8 v) {
  return vector_i8::vector_type(v.value);
}

xtext_really_inline vector_u16 as_vector_u16(const vector_u8 v) {
  return vector_u16::vector_type(v.value);
}

xtext_really_inline vector_u16 as_vector_u16(const simd16<bool> v) {
  return vector_u16::vector_type(v.value);
}

xtext_really_inline vector_u32 as_vector_u32(const vector_u8 v) {
  return vector_u32::vector_type(v.value);
}

xtext_really_inline vector_u32 as_vector_u32(const vector_u16 v) {
  return vector_u32::vector_type(v.value);
}

xtext_really_inline vector_u32 max(vector_u32 a, vector_u32 b) {
  return vec_max(a.value, b.value);
}

xtext_really_inline vector_u32 max(vector_u32 a, vector_u32 b, vector_u32 c) {
  return max(max(a, b), c);
}

xtext_really_inline vector_u32 sum4bytes(vector_u8 bytes, vector_u32 acc) {
...
#endif // XTEXT_SIMDUTF_PPC64_SIMD_INPUT_H
