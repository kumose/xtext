...
xtext_maybe_unused static void
base64_encoding_translate_6bit_values(const xtext::implementation &) {
  using xtext::ppc64::encoding_translate_6bit_values;
  using xtext::ppc64::vector_u8;
...
xtext_maybe_unused static void
base64_encoding_expand_6bit_fields(const xtext::implementation &) {
  using xtext::ppc64::encoding_expand_6bit_fields;
  using xtext::ppc64::vector_u8;
...
xtext_maybe_unused static void
base64_decoding_valid(const xtext::implementation &) {
  using xtext::ppc64::block64;
  using xtext::ppc64::vector_u8;
  using xtext::ppc64::with_base64_std;
  using xtext::ppc64::with_base64_url;
  using xtext::ppc64::with_ignore_errors;
...
static void unittest_decoding_invalid_strict_errors(const char *base64) {
  using xtext::ppc64::block64;
  using xtext::ppc64::vector_u8;
  using xtext::ppc64::with_strict_checking;
...
xtext_maybe_unused static void
base64_decoding_invalid_ignore_errors(const xtext::implementation &) {
  using xtext::ppc64::with_base64_std;
...
xtext_maybe_unused static void
base64url_decoding_invalid_ignore_errors(const xtext::implementation &) {
  using xtext::ppc64::with_base64_url;
...
xtext_maybe_unused static void
base64_decoding_invalid_strict_errors(const xtext::implementation &) {
  using xtext::ppc64::with_base64_std;
...
xtext_maybe_unused static void
base64url_decoding_invalid_strict_errors(const xtext::implementation &) {
  using xtext::ppc64::with_base64_url;
...
xtext_maybe_unused static void
base64_decoding_pack(const xtext::implementation &) {
  using xtext::ppc64::decoding_pack;
  using xtext::ppc64::vector_u8;
...
xtext_maybe_unused static int
scalar_compress(const xtext::ppc64::vector_u8 data, uint16_t nmask,
                char *output) {
  char tmp[16];
  data.store(tmp);
...
xtext_maybe_unused static void
base64_compress(const xtext::implementation &) {
  using xtext::ppc64::compress;
  using xtext::ppc64::vector_u8;
