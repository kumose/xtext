#ifndef XTEXT_SIMDUTF_LASX_IMPLEMENTATION_H
#define XTEXT_SIMDUTF_LASX_IMPLEMENTATION_H
...
public:
  xtext_really_inline implementation()
      : xtext::implementation("lasx", "LOONGARCH ASX",
...
#endif // XTEXT_SIMDUTF_LASX_IMPLEMENTATION_H
