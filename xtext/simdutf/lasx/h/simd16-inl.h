...
struct base16 : base<simd16<T>> {
  ...
  xtext_really_inline base16() : base<simd16<T>>() {}
  xtext_really_inline base16(const __m256i _value)
...
template <> struct simd16<bool> : base16<bool> {
  ...
  xtext_really_inline simd16(const __m256i _value) : base16<bool>(_value) {}
  // Splat constructor
  ...
  xtext_really_inline simd16<bool> operator~() const { return *this ^ true; }

  xtext_really_inline bool is_zero() const {
    return __lasx_xbz_v(this->value);
  }

  template <unsigned N> xtext_really_inline simd16 byte_right_shift() const {
...
template <typename T> struct base16_numeric : base16<T> {
  ...
  static xtext_really_inline simd16<T> zero() { return __lasx_xvldi(0); }
  template <typename Pointer>
  ...
  xtext_really_inline base16_numeric(const __m256i _value)
      : base16<T>(_value) {}
  ...
  xtext_really_inline simd16<T> operator~() const { return *this ^ 0xFFFFu; }
};

// Unsigned code units
template <> struct simd16<uint16_t> : base16_numeric<uint16_t> {
  xtext_really_inline simd16() : base16_numeric<uint16_t>() {}
  xtext_really_inline simd16(const __m256i _value)
...
template <typename T> struct simd16x32 {
  ...
  xtext_really_inline simd16x32(const simd16<T> chunk0,
