...
xtext_really_inline size_t count_code_points(const char *in, size_t size) {
  size_t pos = 0;
  size_t count = 0;
...
#ifdef XTEXT_SIMDUTF_SIMD_HAS_BYTEMASK
xtext_unused xtext_really_inline size_t
...
#endif // XTEXT_SIMDUTF_SIMD_HAS_BYTEMASK

xtext_really_inline size_t utf16_length_from_utf8(const char *in,
                                                    size_t size) {
  size_t pos = 0;
  size_t count = 0;
