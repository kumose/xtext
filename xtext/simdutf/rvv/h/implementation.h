#ifndef XTEXT_SIMDUTF_RVV_IMPLEMENTATION_H
#define XTEXT_SIMDUTF_RVV_IMPLEMENTATION_H
...
public:
  xtext_really_inline implementation()
      : xtext::implementation("rvv", "RISC-V Vector Extension",
...
#if XTEXT_SIMDUTF_IS_ZVBB
  bool supports_zvbb() const { return true; }
#elif XTEXT_SIMDUTF_HAS_ZVBB_INTRINSICS
...
#endif // XTEXT_SIMDUTF_RVV_IMPLEMENTATION_H
