...
xtext_warn_unused size_t implementation::utf32_length_from_utf16le(
  ...
  return rvv_utf32_length_from_utf16<xtext_ByteFlip::NONE>(src, len);
}

xtext_warn_unused size_t implementation::utf32_length_from_utf16be(
    const char16_t *src, size_t len) const noexcept {
  if (supports_zvbb())
    return rvv_utf32_length_from_utf16<xtext_ByteFlip::ZVBB>(src, len);
  else
    return rvv_utf32_length_from_utf16<xtext_ByteFlip::V>(src, len);
}
...
xtext_warn_unused size_t implementation::utf8_length_from_utf16le(
    const char16_t *src, size_t len) const noexcept {
  return rvv_utf8_length_from_utf16<xtext_ByteFlip::NONE>(src, len);
}

xtext_warn_unused size_t implementation::utf8_length_from_utf16be(
    const char16_t *src, size_t len) const noexcept {
  if (supports_zvbb())
    return rvv_utf8_length_from_utf16<xtext_ByteFlip::ZVBB>(src, len);
  else
    return rvv_utf8_length_from_utf16<xtext_ByteFlip::V>(src, len);
}
