#ifndef XTEXT_SIMDUTF_VALID_UTF32_TO_UTF16_H
#define XTEXT_SIMDUTF_VALID_UTF32_TO_UTF16_H
...
xtext_constexpr23 size_t convert_valid(const char32_t *data, size_t len,
