#ifndef XTEXT_SIMDUTF_UTF32_TO_UTF16_H
#define XTEXT_SIMDUTF_UTF32_TO_UTF16_H
...
xtext_constexpr23 size_t convert(const char32_t *data, size_t len,
...
template <endianness big_endian>
xtext_constexpr23 result convert_with_errors(const char32_t *data, size_t len,
                                               char16_t *utf16_output) {
  size_t pos = 0;
  char16_t *start{utf16_output};
  while (pos < len) {
