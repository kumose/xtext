#ifndef XTEXT_SIMDUTF_UTF16_TO_UTF8_H
#define XTEXT_SIMDUTF_UTF16_TO_UTF8_H
...
template <endianness big_endian, typename InputPtr, typename OutputPtr>
  ...
  requires xtext::detail::indexes_into_utf16<InputPtr>
...
#endif
xtext_constexpr23 full_result convert_with_errors(InputPtr data, size_t len,
                                                    OutputPtr utf8_output,
                                                    size_t utf8_len = 0) {
...
template <endianness big_endian>
xtext_constexpr23 size_t convert_with_replacement(const char16_t *data,
                                                    size_t len,
                                                    char *utf8_output) {
  size_t pos = 0;
