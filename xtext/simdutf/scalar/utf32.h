#ifndef XTEXT_SIMDUTF_UTF32_H
#define XTEXT_SIMDUTF_UTF32_H
...
template <typename InputPtr>
  ...
  requires xtext::detail::indexes_into_uint32<InputPtr>
#endif
xtext_warn_unused xtext_constexpr23 bool validate(InputPtr data,
                                                      size_t len) noexcept {
  uint64_t pos = 0;
  for (; pos < len; pos++) {
...
xtext_warn_unused xtext_really_inline bool validate(const char32_t *buf,
                                                        size_t len) noexcept {
...
template <typename InputPtr>
  ...
  requires xtext::detail::indexes_into_uint32<InputPtr>
#endif
xtext_warn_unused xtext_constexpr23 result
...
xtext_warn_unused xtext_really_inline result
...
inline xtext_constexpr23 size_t utf8_length_from_utf32(const char32_t *p,
                                                         size_t len) {
