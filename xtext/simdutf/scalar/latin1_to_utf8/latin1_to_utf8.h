#ifndef XTEXT_SIMDUTF_LATIN1_TO_UTF8_H
#define XTEXT_SIMDUTF_LATIN1_TO_UTF8_H
...
template <typename InputPtr, typename OutputPtr>
  ...
  requires(xtext::detail::indexes_into_byte_like<InputPtr> &&
           xtext::detail::index_assignable_from_char<OutputPtr>)
#endif
xtext_constexpr23 size_t convert(InputPtr data, size_t len,
...
xtext_really_inline size_t convert(const char *buf, size_t len,
                                     char *utf8_output) {
...
template <typename InputPtr, typename OutputPtr>
  ...
  requires(xtext::detail::indexes_into_byte_like<InputPtr> &&
           xtext::detail::index_assignable_from_char<OutputPtr>)
#endif
xtext_constexpr23 size_t convert_safe_constexpr(InputPtr data, size_t len,
                                                  OutputPtr utf8_output,
                                                  size_t utf8_len) {
  size_t pos = 0;
  size_t utf8_pos = 0;
...
template <typename InputPtr>
  ...
  requires xtext::detail::indexes_into_byte_like<InputPtr>
#endif
xtext_constexpr23 xtext_warn_unused size_t
