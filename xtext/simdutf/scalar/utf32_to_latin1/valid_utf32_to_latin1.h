#ifndef XTEXT_SIMDUTF_VALID_UTF32_TO_LATIN1_H
#define XTEXT_SIMDUTF_VALID_UTF32_TO_LATIN1_H
...
xtext_constexpr23 size_t convert_valid(ReadPtr data, size_t len,
...
xtext_really_inline size_t convert_valid(const char32_t *buf, size_t len,
                                           char *latin1_output) {
