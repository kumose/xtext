#ifndef XTEXT_SIMDUTF_UTF32_TO_LATIN1_H
#define XTEXT_SIMDUTF_UTF32_TO_LATIN1_H
...
inline xtext_constexpr23 size_t convert(const char32_t *data, size_t len,
                                          char *latin1_output) {
...
inline xtext_constexpr23 result convert_with_errors(const char32_t *data,
                                                      size_t len,
                                                      char *latin1_output) {
  char *start{latin1_output};
  size_t pos = 0;
