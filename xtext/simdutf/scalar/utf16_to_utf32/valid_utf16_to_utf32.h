#ifndef XTEXT_SIMDUTF_VALID_UTF16_TO_UTF32_H
#define XTEXT_SIMDUTF_VALID_UTF16_TO_UTF32_H
...
xtext_constexpr23 size_t convert_valid(const char16_t *data, size_t len,
