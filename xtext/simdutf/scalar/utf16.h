#ifndef XTEXT_SIMDUTF_UTF16_H
#define XTEXT_SIMDUTF_UTF16_H
...
xtext_warn_unused xtext_constexpr23 bool
...
template <endianness big_endian>
inline xtext_warn_unused xtext_constexpr23 bool
...
template <endianness big_endian>
inline xtext_warn_unused xtext_constexpr23 result
...
template <endianness big_endian>
xtext_constexpr23 size_t count_code_points(const char16_t *p, size_t len) {
...
template <endianness big_endian>
xtext_constexpr23 size_t utf8_length_from_utf16(const char16_t *p,
                                                  size_t len) {
  // We are not BOM aware.
  size_t counter{0};
  for (size_t i = 0; i < len; i++) {
...
template <endianness big_endian>
xtext_constexpr23 size_t utf32_length_from_utf16(const char16_t *p,
                                                   size_t len) {
  // We are not BOM aware.
  size_t counter{0};
  for (size_t i = 0; i < len; i++) {
...
xtext_unused xtext_really_inline constexpr bool high_surrogate(char16_t c) {
  return (0xd800 <= c && c <= 0xdbff);
}

template <endianness big_endian>
xtext_constexpr23 result
...
template <endianness big_endian>
xtext_constexpr23 void to_well_formed_utf16(const char16_t *input, size_t len,
                                              char16_t *output) {
