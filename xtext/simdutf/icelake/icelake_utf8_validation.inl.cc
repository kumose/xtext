...
xtext_really_inline __m512i check_special_cases(__m512i input,
                                                  const __m512i prev1) {
...
xtext_really_inline __m512i check_multibyte_lengths(const __m512i input,
...
//
xtext_really_inline __m512i is_incomplete(const __m512i input) {
...
struct avx512_utf8_checker {
  ...
  //
  xtext_really_inline void check_utf8_bytes(const __m512i input,
                                              const __m512i prev_input) {
  ...
  xtext_really_inline void check_eof() {
  ...
  xtext_really_inline bool check_next_input(const __m512i input) {
    const __m512i v_80 = _mm512_set1_epi8(char(0x80));
  ...
  xtext_really_inline bool errors() const {
