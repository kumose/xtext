#ifndef XTEXT_SIMDUTF_ICELAKE_INTRINSICS_H
#define XTEXT_SIMDUTF_ICELAKE_INTRINSICS_H
...
XTEXT_SIMDUTF_POP_DISABLE_WARNINGS
  ...
  #endif //  _blsr_u64
#endif   // XTEXT_SIMDUTF_CLANG_VISUAL_STUDIO

#if defined(__GNUC__) && !defined(__clang__)

  #if __GNUC__ == 8
    #define XTEXT_SIMDUTF_GCC8 1
  #elif __GNUC__ == 9
    #define XTEXT_SIMDUTF_GCC9 1
  #endif //  __GNUC__ == 8 || __GNUC__ == 9

#endif // defined(__GNUC__) && !defined(__clang__)

#if XTEXT_SIMDUTF_GCC8
...
#endif // XTEXT_SIMDUTF_GCC8

#endif // XTEXT_SIMDUTF_HASWELL_INTRINSICS_H
