...
template <> struct simd16<uint16_t> {
  ...
  static xtext_really_inline simd16<uint16_t> load(const Pointer *ptr) {
    return simd16<uint16_t>(ptr);
  }

  __m512i value;

  xtext_really_inline simd16(const __m512i v) : value(v) {}

  template <typename Pointer>
  xtext_really_inline simd16(const Pointer *ptr)
  ...
  // methods
  xtext_really_inline simd16 swap_bytes() const {
  ...
  // static members
  xtext_really_inline static simd16<uint16_t> zero() {
    return _mm512_setzero_si512();
  }

  xtext_really_inline static simd16<uint16_t> splat(uint16_t v) {
...
template <> struct simd16<bool> {
  ...
  xtext_really_inline simd16(const __mmask32 v) : value(v) {}
};

// ------------------------------------------------------------

xtext_really_inline simd16<uint16_t> min(const simd16<uint16_t> b,
