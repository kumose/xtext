...
#include <xtext/simdutf/icelake/icelake_macros.inl.cc>
#include <xtext/simdutf/icelake/icelake_common.inl.cc>
#if XTEXT_SIMDUTF_FEATURE_UTF8
  #include <xtext/simdutf/icelake/icelake_utf8_common.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8

#if XTEXT_SIMDUTF_FEATURE_UTF8 || XTEXT_SIMDUTF_FEATURE_DETECT_ENCODING
  #include <xtext/simdutf/icelake/icelake_utf8_validation.inl.cc>
  ...
  #include <xtext/simdutf/icelake/icelake_from_valid_utf8.inl.cc>
  #include <xtext/simdutf/icelake/icelake_from_utf8.inl.cc>
  ...
  #include <xtext/simdutf/icelake/icelake_utf16fix.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16
#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1
  #include <xtext/simdutf/icelake/icelake_convert_utf8_to_latin1.inl.cc>
  #include <xtext/simdutf/icelake/icelake_convert_valid_utf8_to_latin1.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_LATIN1

#if XTEXT_SIMDUTF_FEATURE_UTF16
  #include <xtext/simdutf/icelake/icelake_convert_utf16_to_latin1.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16
  #include <xtext/simdutf/icelake/icelake_convert_utf16_to_utf8.inl.cc>
  #include <xtext/simdutf/icelake/icelake_convert_utf8_to_utf16.inl.cc>
  #include <xtext/simdutf/icelake/icelake_utf8_length_from_utf16.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF16

#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/icelake/icelake_convert_utf16_to_utf32.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/icelake/icelake_convert_utf32_to_latin1.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/icelake/icelake_convert_utf32_to_utf8.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8 && XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/icelake/icelake_convert_utf32_to_utf16.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16 && XTEXT_SIMDUTF_FEATURE_UTF32

#if XTEXT_SIMDUTF_FEATURE_ASCII
  #include <xtext/simdutf/icelake/icelake_ascii_validation.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_ASCII
#if XTEXT_SIMDUTF_FEATURE_UTF32 || XTEXT_SIMDUTF_FEATURE_DETECT_ENCODING
  #include <xtext/simdutf/icelake/icelake_utf32_validation.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF32 || XTEXT_SIMDUTF_FEATURE_DETECT_ENCODING
#if XTEXT_SIMDUTF_FEATURE_UTF8
  #include <xtext/simdutf/icelake/icelake_convert_latin1_to_utf8.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF8
#if XTEXT_SIMDUTF_FEATURE_UTF16
  #include <xtext/simdutf/icelake/icelake_convert_latin1_to_utf16.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF16
#if XTEXT_SIMDUTF_FEATURE_UTF32
  #include <xtext/simdutf/icelake/icelake_convert_latin1_to_utf32.inl.cc>
#endif // XTEXT_SIMDUTF_FEATURE_UTF32
#if XTEXT_SIMDUTF_FEATURE_BASE64
  #include <xtext/simdutf/icelake/icelake_base64.inl.cc>
  #include <xtext/simdutf/icelake/icelake_find.inl.cc>
...
xtext_warn_unused result implementation::convert_utf8_to_utf32_with_errors(
  ...
  if (std::get<0>(ret) == end) {
    return {xtext::SUCCESS, saved_bytes};
  }
  ...
  if (std::get<0>(ret) != end) {
    ...
    if (scalar_result.error != xtext::SUCCESS) {
  ...
  return {xtext::SUCCESS, size_t(std::get<1>(ret) - utf32_output)};
}
...
xtext_warn_unused result implementation::convert_utf16le_to_utf32_with_errors(
  ...
  return xtext::result(xtext::SUCCESS, saved_bytes);
}
