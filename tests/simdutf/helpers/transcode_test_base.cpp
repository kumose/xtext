...
#include "tests/simdutf/reference/encode_utf8.h"
#include "tests/simdutf/reference/encode_utf16.h"
#include "tests/simdutf/reference/encode_utf32.h"
#include "tests/simdutf/reference/encode_latin1.h"
#include "tests/simdutf/reference/decode_utf16.h"
#include "tests/simdutf/reference/decode_utf32.h"
#include "tests/simdutf/reference/validate_utf8.h"
#include "tests/simdutf/reference/validate_utf16.h"
#include "tests/simdutf/reference/validate_utf32.h"
#include "tests/simdutf/reference/validate_utf8_to_latin1.h"
#include "tests/simdutf/reference/validate_utf16_to_latin1.h"
#include "tests/simdutf/reference/validate_utf32_to_latin1.h"
...
void transcode_test_base::encode_utf8(uint32_t codepoint,
  ...
  ::xtext::tests::reference::utf8::encode(
...
void transcode_test_base::encode_utf16(uint32_t codepoint,
  ...
  char16_t W1;
  char16_t W2;
  switch (::xtext::tests::reference::utf16::encode(codepoint, W1, W2)) {
  case 1:
...
bool transcode_utf8_to_latin1_test_base::is_input_valid() const {
  return xtext::tests::reference::validate_utf8_to_latin1(input_utf8.data(),
                                                            input_utf8.size());
}
...
transcode_utf16_to_latin1_test_base::transcode_utf16_to_latin1_test_base(
  ...
  auto error_handler = [](const char16_t *, const char16_t *,
                          xtext::tests::reference::utf16::Error) -> bool {
    throw std::invalid_argument("Wrong UTF-16 input");
  };
  xtext::tests::reference::utf16::decode(utf16_endianness, input_utf16.data(),
...
bool transcode_utf16_to_latin1_test_base::is_input_valid() const {
  return xtext::tests::reference::validate_utf16_to_latin1(
...
bool transcode_utf8_to_utf16_test_base::is_input_valid() const {
  return xtext::tests::reference::validate_utf8(input_utf8.data(),
                                                  input_utf8.size());
}
...
transcode_utf16_to_utf8_test_base::transcode_utf16_to_utf8_test_base(
  ...
  auto consume = [this](const uint32_t codepoint) {
    ::xtext::tests::reference::utf8::encode(codepoint, [this](uint8_t byte) {
...
bool transcode_utf16_to_utf8_test_base::is_input_valid() const {
  return xtext::tests::reference::validate_utf16(
      utf16_endianness, input_utf16.data(), input_utf16.size());
}
...
bool transcode_utf32_to_latin1_test_base::is_input_valid() const {
  return xtext::tests::reference::validate_utf32_to_latin1(
...
transcode_utf32_to_utf8_test_base::transcode_utf32_to_utf8_test_base(
  ...
  auto error_handler = [](const char32_t *, const char32_t *,
                          xtext::tests::reference::utf32::Error) -> bool {
    throw std::invalid_argument("Wrong UTF-32 input");
  };
  xtext::tests::reference::utf32::decode(
...
bool transcode_utf32_to_utf8_test_base::is_input_valid() const {
  return xtext::tests::reference::validate_utf32(input_utf32.data(),
                                                   input_utf32.size());
}
...
all_utf16_combinations(xtext::endianness byte_order) {
