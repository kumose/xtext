...
TEST(compile_time_validation) {
  ...
  static_assert(xtext::validate_utf16le(u"hello!"_utf16le));
  static_assert(xtext::validate_utf16(u"hello!"_utf16));
  ...
  static_assert(not xtext::validate_utf16le(invalid_le));
  static_assert(not xtext::validate_utf16(invalid));
}

TEST(compile_time_ascii_validation_le) {
  using namespace xtext::tests::helpers;
  static_assert(
      xtext::validate_utf16_as_ascii(u"I am ascii, I promise!"_utf16le));
  static_assert(not xtext::validate_utf16_as_ascii(
